class Auto {
    constructor({marca, modelo, imgURL, precio, porcentajeDeGanancias}){
        this.marca = marca;
        this.modelo = modelo;
        this.imgURL = imgURL;
        this.precio = precio;
        this.porcentajeDeGanancias = porcentajeDeGanancias;
        this.gananciasDelVendedor = precio * porcentajeDeGanancias;
    }
}
...
const autosOrdenadosPorGanancias = [...autos].sort((a,b) => b.gananciasDelVendedor - a.gananciasDelVendedor);

console.log(autos)
console.log(autosOrdenadosPorGanancias)

export { autos, autosOrdenadosPorGanancias };